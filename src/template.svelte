  ...
  <div
    ...
    <div 
      ...
      <a
        ...
        <img width="16" height="16" src="{assetsRoot}/images/ad/canadian-tire/chevron-right-black.svg" alt="" />
      </a>
    </div>
  </div>
  <!--/THIN-->
{:else if aspectRatio < 0.8}
    ...
    <div 
      ...
      <div>
        ...
        <div class="flex flex-col gap-1 pb-2.5 pt-2">
          ...
          <h2 class="text-[58px] font-extrabold leading-none text-white max-w-[268px] max-h-[98px] overflow-hidden shrink-0 w-[268px] h-[98px]" use:autoSize>
            {content.savings}
          </h2>
        </div>
      ...
      <div class="relative pt-1.5">
        <img
          class="mx-auto max-h-[185px] overflow-hidden object-contain"
          alt={content.name}
  ...
  <div
    ...
    <div
      ...
      <div class="relative mt-3 flex flex-col gap-1.5">
        <img
          ...
          alt="Red Thursday Sale Promo Banner" />
        <h2
          class="shrink-0 text-[24px] font-extrabold leading-none text-white max-w-[124px] max-h-[48px] overflow-hidden" use:autoSize>
          {content.savings}
        </h2>
    ...
    <!--COL(right)-->
    <div 
      class="flex-col- mx-auto flex w-[160px] shrink-0 items-center pl-1.5 pr-2.5" 
      use:animation={{
        controller: animationController,
        options: {
          name: "fadeIn",
      ...
      <div class="relative w-full">
        <img class="mx-auto max-w-[144px] max-h-[180px] object-contain" alt={content.name} src={content.imageUrl} />
        <img
          alt=""
  ...
  <div class="flex gap-7 h-full overflow-hidden bg-[#ED1C24] bg-[url('{assetsRoot}/images/ad/canadian-tire/bg-triangle-red-970x250.svg')] p-4 pt-3">
    <!--Logo-->
    <div 
      use:animation={{
        controller: animationController,
    ...
    <div 
      ...
      <div class="pb-0 pt-2">
        ...
        <h2 class="text-[70px] font-extrabold text-white font-ct-eastman-compressed--- leading-none max-w-[565px] max-h-[70px] overflow-hidden shrink-0 w-[565px] h-[70px]" use:autoSize>
          {content.savings}
        </h2>
      </div>
      <!--/Promo text-->
    ...
    <div class="relative self-center ml-auto"
      ...
      <img class="max-h-[214px] max-w-60 object-contain overflow-hidden" alt={content.name} src={content.imageUrl} />
      <!-- <img
        alt=""
        class="absolute left-0 top-0 h-1/3 w-1/3 object-contain object-[left_top]"
        use:editable={{
  ...
  {@const LOGO_SIZE = [27, 27] as [number, number]}
  <div
    class="flex h-full gap-x-4 overflow-hidden bg-[#ED1C24] bg-[url('{assetsRoot}/images/ad/canadian-tire/temp-1.svg')] px-2.5">
    <!--BRAND-->
    <div 
      class="pt-3" 
      use:animation={{
