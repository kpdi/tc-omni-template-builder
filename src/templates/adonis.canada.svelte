...
{#if aspectRatio > 6 && aspectRatio < 7}
  <!-- THIN LAYOUT (320x50) -->
  <div
    class="bg-[#CC112C] bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-canada-320x50.svg')] bg-cover h-full w-full overflow-hidden flex"
    use:animation={{
    ...
    <Row height="100%" class="px-[8px] py-[6px]">
      ...
      <Column width="50%" class="flex-none">
        <Image
          ...
          src={{
            default: `${assetsRoot}/images/ad/adonis/logo-adonis-white.svg`,
          }}
...
{:else if aspectRatio < 0.8}
  <!-- TALL LAYOUT (300x600) -->
  <div
    class="bg-[#CC112C] bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-canada-300x600.svg')] bg-cover h-full w-full overflow-hidden"
    use:animation={{
      controller: animationController,
      options: {
        name: "fadeIn",
    ...
    <Column width="100%" class="p-[10px]">
            ...
            <Row height="116px" class="mt-[-14px]">
              <Column width={price.dollars.length === 1 ? "32px" : "64px"}>
                <Text
                  ...
                  class="font-kapra text-white font-bold"
                  height={{ default: "100%" }}
                  width={{ default: "100%" }}
                  bottom={{ default: "0" }}
                  left={{ default: "0" }}
                  style={{ "-webkit-text-stroke": "2px #572D2E" }}
                  justify={{ default: "center" }}
                />
              </Column>
          ...
          {#if frame["item.0.name"]}
            <Row height="100px">
              <Text
                ...
                {frame}
                name="tall.name"
                class="font-bold font-gotham-condensed text-white text-left items-center"
                height={{ default: "100%" }}
                width={{ default: "100%" }}
                top={{ default: "0" }}
                left={{ default: "0" }}
          ...
          {#if frame["item.0.description"]}
            <Row height="32px">
              <Text
                ...
                class="text-white text-left font-gotham-condensed"
                height={{ default: "100%" }}
                width={{ default: "100%" }}
                top={{ default: "0" }}
                left={{ default: "0" }}
      ...
      <Row height="24px" class="mt-[8px]">
        <Text
          ...
          class="font-gotham-condensed text-white"
          align={{ default: "center" }}
          justify={{ default: "center" }}
          height={{ default: "100%" }}
          width={{ default: "100%" }}
...
{:else if aspectRatio < 1.5}
  ...
  <div
    class="bg-[#CC112C] bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-canada-300x250.svg')] bg-cover h-full w-full overflow-hidden"
  >
    <div
                ...
                <Row height="100%">
                  <Column width={price.dollars.length === 1 ? "30px" : "39px"}>
                    <Text
                      ...
                      class="font-kapra text-white font-bold text-[60px] leading-[55px]"
                      height={{ default: "100%" }}
                      width={{ default: "100%" }}
                      bottom={{ default: "0" }}
                      left={{ default: "0" }}
                      style={{ "-webkit-text-stroke": "1px #572D2E" }}
                      justify={{ default: "center" }}
                    />
                  </Column>
          ...
          {#if frame["item.0.name"]}
            <Row height="52px" class="mt-[-10px]">
              <Text
                ...
                {frame}
                name="square.name"
                class=" font-bold font-gotham-condensed text-white text-right"
                height={{ default: "100%" }}
                width={{ default: "100%" }}
                top={{ default: "0" }}
                left={{ default: "0" }}
          ...
          {#if frame["item.0.description"]}
            <Row height="22px">
              <Text
                ...
                class="text-white text-right font-gotham-condensed"
                height={{ default: "100%" }}
                width={{ default: "100%" }}
                top={{ default: "0" }}
                left={{ default: "0" }}
...
{:else}
  <!-- WIDE LAYOUT (728x90) -->
  <div
    class="bg-[#EDD2A9] bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-canada-728x90.svg')] bg-cover h-full w-full overflow-hidden"
    use:animation={{
      controller: animationController,
      options: {
        name: "fadeIn",
        ...
        {#if frame["item.0.name"]}
          <Row height="40px">
            <Text
              ...
              {frame}
              name="wide.name"
              class="font-bold font-gotham-condensed text-white text-left leading-none"
              height={{ default: "100%" }}
              width={{ default: "100%" }}
              top={{ default: "0" }}
              left={{ default: "0" }}
        ...
        {#if frame["item.0.description"]}
          <Row height="14px">
            <Text
              ...
              class="text-white text-left font-gotham-condensed text-[14px] leading-none"
              height={{ default: "100%" }}
              width={{ default: "100%" }}
              top={{ default: "0" }}
              left={{ default: "0" }}
      ...
      <Column width="148px">
        ...
        <Row height="26px" class="p-[6px]">
          <Text
            ...
            name="wide.validity"
            text={{ default: validity }}
            class="font-gotham-condensed text-white text-right"
            height={{ default: "100%" }}
            width={{ default: "100%" }}
            top={{ default: "0" }}
            left={{ default: "0" }}
