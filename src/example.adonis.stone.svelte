    ...
    <Column width="100%" class="p-[10px]">
      ...
      <Row height="24px" class="mt-[8px]">
        <Text
          ...
          text={{
            default: getValidity(
              frame["item.0.validFrom"],
              frame["item.0.validTo"],
              lang
            ),
          }}
        ...
        <Column width="198px">
          ...
          <Row height="24px" class="py-[2px]">
            <Link
              ...
              class="bg-adonis-sky-medium font-gotham hover:bg-adonis-sky-medium/90 rounded px-[12px] py-[5px] text-center font-bold text-white transition-colors duration-300 ease-in-out"
              height={{ default: "100%" }}
              width={{ default: "100%" }}
              top={{ default: "0" }}
              right={{ default: "0" }}
