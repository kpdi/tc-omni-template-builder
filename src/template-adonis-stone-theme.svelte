...
{:else if aspectRatio < 0.8}
  ...
  <div
    class="bg-[#EDD2A9] flex h-full flex-col bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-stone-300x600.svg')] bg-cover py-2.5 px-2.5"
  >
    <!--HEADER-->
    <div
        ...
        <div class="-bottom-1 relative self-end">
          ...
          {#if content.price}
            ...
            <div
              ...
              <span
                class="text-adonis-red-medium max-h-[90px] overflow-hidden text-[90px] leading-[85px] font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white] mt-1"
                use:autoSize>
                {dollars}
              </span>
              <span class="-mt-px ml-0.5 flex flex-col">
                {#if cents}
                  <span
                    class="text-adonis-red-medium max-h-[60px] max-w-[50px] overflow-hidden text-[60px] leading-normal font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white]"
                    use:autoSize>
                    {cents}
                  </span>
                {/if}
                {#if content.price.includes("/")}
                  <span
                    class="ml-0.5 text-xl leading-none text-adonis-red-medium">
                    /{content.price.split("/")[1]}
                  </span>
                {/if}
              </span>
              <span
                class="text-lg text-adonis-red-medium font-semibold mt-2 ml-0.5 z-10">+TX</span>
            </div>
          {/if}
          <!--/PRICE-->
        </div>
...
{:else if aspectRatio < 1.5}
  ...
  <div
    class="relative bg-[#EDD2A9] h-full overflow-hidden bg-[url('{assetsRoot}/images/ad/adonis/bg-adonis-stone-300x250.svg')] bg-cover py-2"
  >
      ...
      >
        <div class="ml-auto mt-0.5">
          ...
          {#if content.price}
            ...
            >
              <span
                class="text-adonis-red-medium max-h-[70px] overflow-hidden text-[70px] leading-[65px] font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white] mt-1.5"
                use:autoSize
              >
                {dollars}
              </span>
              <span class="-mt-px ml-0.5 flex flex-col">
                {#if cents}
                  <span
                    class="text-adonis-red-medium mt-[2px] max-h-[48px] max-w-[35px] overflow-hidden text-[48px] leading-normal font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white]"
                    use:autoSize
                  >
                    {cents}
                  </span>
                ...
                {#if content.price.includes("/")}
                  <span
                    class="ml-0.5 text-[15px] leading-none text-adonis-red-medium"
                  >
                    /{content.price.split("/")[1]}
                  </span>
                {/if}
              ...
              <span
                class="text-[14px] text-adonis-red-medium font-semibold mt-2 ml-0.5 z-10"
                >+TX</span
              >
            </div>
          {/if}
        ...
        <!--NAME-->
        <div
          class="font-gotham-condensed mt-1 text-right leading-none text-adonis-blue-extralight"
        >
          <h2
            class="max-h-[72px] max-w-[122px] overflow-hidden text-[18px] leading-none font-bold"
            use:editable={{
              controller: editController,
              content,
              itemIndex: 0,
    ...
    <!--CTA-->
    <div
      class="absolute bottom-1 left-1/2 -translate-x-1/2 text-center"
      use:animation={{
        controller: animationController,
        options: {
          name: "fadeIn",
    ...
    >
      <div>
        ...
        {#if content.price}
          ...
          >
            <span
              class="text-adonis-red-medium max-h-[70px] overflow-hidden text-[70px] leading-[60px] font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white] mt-[6px]"
              use:autoSize
            >
              {dollars}
            </span>
            <span class="-mt-px ml-0.5 flex flex-col">
              {#if cents}
                <span
                  class="text-adonis-red-medium mt-[2px] max-h-[46px] max-w-[35px] overflow-hidden text-[48px] leading-normal font-bold [text-shadow:-2px_-2px_0_white,2px_2px_0_white,-2px_2px_0_white,2px_-2px_0_white]"
                  use:autoSize
                >
                  {cents}
                </span>
